...
store.projects.forEach(p => { p.activeSection = "full"; });
...
function startMetronome(){
  ...
  const tick = () => {
    ...
    if(activeDrum === 1){
      ...
      if(step16 === 2 || step16 === 10 || step16 === 14){
        playHat(t + (intervalMs/1000)*0.5, 0.10);
      }
      if(step16 === 0 || step16 === 3 || step16 === 8 || step16 === 11 || step16 === 14) playKick();
      if(step16 === 4 || step16 === 12) playSnare();
    }else if(activeDrum === 6){
      playHat(t, 0.16);
      if(step16 === 1 || step16 === 5 || step16 === 9 || step16 === 13) playHat(t + (intervalMs/1000)*0.25, 0.10);
      if(step16 === 0 || step16 === 4 || step16 === 10 || step16 === 15) playKick();
      if(step16 === 8 || step16 === 12) playSnare();
    }else if(activeDrum === 7){
      playHat(t, step16 % 4 === 0 ? 0.20 : 0.13);
      if(step16 === 6 || step16 === 7 || step16 === 14){
        playHat(t + (intervalMs/1000)*0.33, 0.11);
        playHat(t + (intervalMs/1000)*0.66, 0.09);
      }
      if(step16 === 0 || step16 === 5 || step16 === 6 || step16 === 10 || step16 === 13) playKick();
      if(step16 === 4 || step16 === 11) playSnare();
    }else if(activeDrum === 8){
      playHat(t, step16 % 2 === 0 ? 0.17 : 0.09);
      if(step16 === 15) playHat(t + (intervalMs/1000)*0.5, 0.12);
      if(step16 === 0 || step16 === 2 || step16 === 7 || step16 === 8 || step16 === 12) playKick();
      if(step16 === 4 || step16 === 10 || step16 === 14) playSnare();
    }
...
(async function boot(){
  ...
  requestAnimationFrame(()=>{
    const p = getActiveProject();
    if(p) p.activeSection = "full";
    try{ snapPagerToPageKey("full", "auto"); }catch(_e){}
  });
